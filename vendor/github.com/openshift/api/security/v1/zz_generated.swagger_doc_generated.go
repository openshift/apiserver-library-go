...
var map_SecurityContextConstraints = map[string]string{
	...
	"hostUsers":                       "hostUsers determines if the policy allows host users in containers. Valid values are \"Allowed\", \"Disallowed\" and omitted. When omitted, this means no opinion and the platform is left to choose a reasonable default. The current default is \"Allowed\".",
