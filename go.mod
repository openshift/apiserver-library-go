...
replace github.com/openshift/library-go => github.com/dusk125/library-go v0.0.0-20241205200714-c36131dededa
...
require (
	...
	k8s.io/kubernetes v1.32.0-rc.1
...
require (
	...
	k8s.io/apiextensions-apiserver v0.32.0-rc.1 // indirect
