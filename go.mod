...
// k8s.io/kubernetes is not meant to be imported and bring in dependencies at v0.0.0,
// which fail to resolve, so resolution failures need to be addressed explicitly here.
replace (
