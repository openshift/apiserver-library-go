...
require (
	...
	k8s.io/kubernetes v1.31.0-rc.0
	k8s.io/utils v0.0.0-20240711033017-18e509b52bc8
)

replace github.com/openshift/api => github.com/atiratree/api v0.0.0-20240806184416-f1867d7a269a
...
replace github.com/openshift/client-go => github.com/atiratree/client-go v0.0.0-20240806192507-e625873a5b71

replace github.com/openshift/library-go => github.com/atiratree/library-go v0.0.0-20240806193830-2ad19c383442
...
require (
	...
	k8s.io/apiextensions-apiserver v0.31.0-rc.0 // indirect
