...
func TestValidatePodSecurityContextFailures(t *testing.T) {
	...
	errorCases := map[string]struct {
		...
		"failRequireHostUser": {
			...
			expectedError: "spec.hostUsers: Invalid value: true: Host Users is not allowed to be used",
		},
		"failUnsetRequireHostUser": {
			pod:           defaultPod(),
			scc:           failUserNamespaceSCC,
			expectedError: `spec.hostUsers: Invalid value: "null": Host Users is not allowed to be used`,
		},
	}
